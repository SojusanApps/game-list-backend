...
from game_list.games.models import GameListStatus
from game_list.moderation.masking import MODERATION_PLACEHOLDER_USERNAME, mask_if_moderated
...
class UserDetailSerializer(serializers.ModelSerializer[UserModel]):
    ...
    @extend_schema_field(
        lazy_serializer("game_list.games.serializers.GameListSerializer")(many=True),
    )
    def get_latest_game_list_updates(self: Self, instance: UserModel) -> ReturnDict[Any, Any]:
        ...
        from game_list.games.serializers import GameListSerializer  # noqa: PLC0415
