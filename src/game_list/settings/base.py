"""This is a base configuration for GameList Django application."""
...
from game_list import __version__
...
MIDDLEWARE = [
    ...
    "game_list.users.middleware.UpdateLastActivityMiddleware",
...
DATABASES = {
    "default": {
        ...
        "NAME": oeg("POSTGRES_DB", "game_list"),
        "USER": oeg("POSTGRES_USER", "game_list"),
        "PASSWORD": oeg("POSTGRES_PASSWORD", "game_list"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("game_list.game_list.authentication.KeycloakAuthentication",),
...
KEYCLOAK_REALM = oeg("KEYCLOAK_REALM", "game-list")
KEYCLOAK_AUDIENCE = oeg("KEYCLOAK_AUDIENCE", "game-list-frontend")
KEYCLOAK_CLIENT_ID = oeg("KEYCLOAK_CLIENT_ID", "game-list-frontend")

SPECTACULAR_SETTINGS = {
    "TITLE": "Sojusan GameList API",
    ...
    "ENUM_NAME_OVERRIDES": {
        "GameListStatusEnum": "game_list.games.models.GameListStatus",
        "TranslationSuggestionStatusEnum": "game_list.games.models.TranslationSuggestionStatus",
        "ReportStatusEnum": "game_list.moderation.models.ReportStatus",
    },
}

GL_LOG_DIR_PATH = oeg("GL_LOG_DIR_PATH", BASE_DIR.parent.parent / "logs")
GL_LOG_FILENAME = oeg("GL_LOG_FILENAME", "game_list.log")

if not (log_path := Path(GL_LOG_DIR_PATH)).is_dir():
    log_path.mkdir(exist_ok=True)

LOG_FILE_PATH = Path(GL_LOG_DIR_PATH, GL_LOG_FILENAME)
...
LOGGING = {
    ...
    "filters": {
        ...
        "otel_fallback": {
            "()": "game_list.settings.base.OTelFallbackFilter",
        },
    },
    "formatters": {
        "color": {
...
CELERY_BEAT_SCHEDULE = {
    "cleanup-notifications-daily": {
        "task": "game_list.notifications.tasks.cleanup_old_notifications",
        "schedule": timedelta(days=1),
    },
    "notify-game-releases-daily": {
        "task": "game_list.notifications.tasks.notify_game_releases",
        "schedule": crontab(hour=3, minute=0),
    },
    "nightly-igdb-import-and-recalculate": {
        "task": "game_list.games.tasks.nightly_igdb_import_and_recalculate",
